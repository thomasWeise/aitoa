...
Every algorithm is implemented in Java&nbsp;1.8 and all accompanying sources codes are provided in an additional [GitHub repository](http://github.com/thomasWeise/aitoa-code).
